...
const Banner = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-tr from-primary/50 via-background to-primary/50 mx-auto rounded-xl">
      ...
      {/* Content — no mounted guard needed, Framer Motion handles SSR */}
      <motion.div
